...
QT_MOC_LITERAL(4, 67, 21), // "slot_SliderPulseReact"
QT_MOC_LITERAL(5, 89, 5), // "value"
QT_MOC_LITERAL(6, 95, 22), // "slot_SliderMotionReact"
QT_MOC_LITERAL(7, 118, 27), // "slot_SliderContrastStrength"
QT_MOC_LITERAL(8, 146, 18), // "slot_DSBPulseReact"
QT_MOC_LITERAL(9, 165, 19), // "slot_DSBMotionReact"
QT_MOC_LITERAL(10, 185, 24) // "slot_DSBContrastStrength"

    },
    "CreateVideoWindow\0slot_OnBtnBackClicked\0"
    "\0slot_OnBtnGenerateClicked\0"
    "slot_SliderPulseReact\0value\0"
    "slot_SliderMotionReact\0"
    "slot_SliderContrastStrength\0"
    "slot_DSBPulseReact\0slot_DSBMotionReact\0"
    "slot_DSBContrastStrength"
};
...
void CreateVideoWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->slot_SliderPulseReact((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: _t->slot_SliderMotionReact((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 4: _t->slot_SliderContrastStrength((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 5: _t->slot_DSBPulseReact((*reinterpret_cast< double(*)>(_a[1]))); break;
        case 6: _t->slot_DSBMotionReact((*reinterpret_cast< double(*)>(_a[1]))); break;
        case 7: _t->slot_DSBContrastStrength((*reinterpret_cast< double(*)>(_a[1]))); break;
        default: ;
        }
    }
}
